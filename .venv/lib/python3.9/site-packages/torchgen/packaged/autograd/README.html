...
commentsRunWhenDOMLoaded(addUtterances);
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.9/site-packages/torchgen/packaged/autograd/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/.venv/lib/python3.9/site-packages/torchgen/packaged/autograd/README.md" target="_blank"
...
the <code class="docutils literal notranslate"><span class="pre">add_custom_command</span></code> call.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.9/site-packages/torchgen/packaged/autograd"
        },
